...
namespace response {
    ...
    public:
        ...
        virtual bool operator == (const ResponseBody &other) const = 0;
    };
    ...
    public:
        ...
        bool operator==(const ResponseBody &other) const override;
    };
    ...
    class Response {
    private:
        std::shared_ptr<ResponseBody> responseBody;
        Status status;
    public:
        explicit Response(std::shared_ptr<ResponseBody> responseBody);
