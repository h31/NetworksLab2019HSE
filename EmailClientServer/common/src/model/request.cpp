...
bool SendEmailRequest::operator==(const SendEmailRequest &other) const {
    return (getAuthor() == other.getAuthor()) && (email == other.email) && (getRequestType() == other.getRequestType());
}
...
bool CheckEmailRequest::operator==(const CheckEmailRequest &other) const {
    return (getAuthor() == other.getAuthor()) && (getRequestType() == other.getRequestType());
}
...
bool GetEmailRequest::operator==(const GetEmailRequest &other) const {
    return (getAuthor() == other.getAuthor()) && (id == other.id) && (getRequestType() == other.getRequestType());
}
